...
var Simulation = function(){
	...
	this.runSimulation = function(){
		...
		//replace all vehicle
		_this.crossroad.placeAllVehicles();
		//add result for this loop
		_this.addResult(txtResult, _this.resultLs.length);
		//if there are not any more vehicle, stop running the simulation
		if(_this.crossroad.checkIfEmpty()){
			_this.playpause();
			return;
		}
	}
	//method to add result at the end of the list of result
